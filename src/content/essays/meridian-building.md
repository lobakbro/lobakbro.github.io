---
title: "Building Meridian: Adaptive Learning in a Chaotic System"
...
author: Kevin Ong
category: research
tags: [meridian, adaptive-learning, knowledge-space-theory, ai, evaluation]
featured: true
draft: true
readingTime: "8 min read"
---

Meridian started because I needed to prep for interviews and everything available was bad. Not bad in the obvious ways — the questions were fine, the platforms worked. Bad in the way that matters: none of them knew what I actually needed to learn next.
...
## What BKT and Spaced Repetition Are Supposed to Solve

This is where Bayesian Knowledge Tracing and spaced repetition scheduling come in — and where I'm currently working.

BKT gives you a probabilistic model of whether a student has "learned" a skill based on their response pattern. It accounts for guessing and slipping — a correct answer doesn't necessarily mean mastery, and an incorrect answer doesn't necessarily mean ignorance. The model updates with each interaction, giving you a running posterior probability of mastery for each skill.

Spaced repetition (FSRS specifically) handles the forgetting curve — when should the student see this material again to maximize retention? The timing matters because memory consolidation is a physical process. Too soon and you're wasting time. Too late and you're starting over.

The integration challenge is getting these systems to talk to each other and to the content generation layer. BKT says the student has a 73% probability of mastering "recursion." FSRS says their last review of recursion-related material was 4 days ago and they're at risk of forgetting. The adaptive engine needs to synthesize these signals and decide: do we reinforce recursion, push forward to dynamic programming (which depends on recursion), or context-switch to behavioral questions because the student's been grinding algorithms for too long?
...
I'm still building Meridian. The evaluation problem isn't solved — I'm not sure it can be, in the traditional ML sense. But the process of trying to solve it has taught me more about how learning actually works than anything I could have read.
